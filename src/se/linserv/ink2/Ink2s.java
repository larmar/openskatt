...
public class Ink2s {
    ...
    private Map<Integer,Sru> ink2s = new HashMap<Integer, Sru>();
	...
	public void load() throws IOException { 
      ...
      System.out.println(f.getAbsolutePath()); 
        ...
        while ((line = bReader.readLine()) != null) {
            ...
            sru.setMultiplier(datavalue[3].equals("+") ? "1" : "-1");
            ink2s.put(sru.getSrukod(),sru);
	...
	public int multiplier(Integer sru) {
		return ink2s.get(sru).getMultiplier();
	}
	
	public String line(Integer sru) {
		return ink2s.get(sru).getLine();
	}
	
	public String description(Integer sru) {
		return ink2s.get(sru).getDescription();
	}
	
	public void setValue(Integer sru, String value) {
		ink2s.get(sru).setValue(value);
	}
	
	public String getValue(Integer sru){
		return ink2s.get(sru).getValue();
	}
	
	public Set<Integer> keySet(){
		SortedSet<Integer> values = new TreeSet<Integer>(ink2s.keySet());
		return values;
	}
